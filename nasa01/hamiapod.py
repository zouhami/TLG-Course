...
NASAAPI = 'https://api.nasa.gov/planetary/apod?MYKEY= "api_key=PAfHUOppaRFTi5mevR2XWpfAHqL6Zr5wZsTc9lq7"' # this is our API to call
MYKEY = 'api_key=DEMO_KEY' ## this is our api key

## pretty print json
def main():
    """run-time code"""
    DATE= input("Enter the desire date in format yyyy-mm-dd")
